...
class AdminController extends \yii\web\Controller {
	...
	public $rootAdminPermission = [
		...
		'Rso Report'=>['rso-rpt/current','rso-rpt/close_mod','rso-rpt/delete','rso-rpt/help','rso-rpt/index','rso-rpt/remarks','rso-rpt/sticker','rso-rpt/update','rso-rpt/view','sticker/add','sticker/move','rso-rpt/sticker-update','rso-rpt/sticker-delete'],
	...
	public $adminPermission = [
		...
		'Rso Report'=>['rso-rpt/close_mod','rso-rpt/help','rso-rpt/index','rso-rpt/remarks','rso-rpt/sticker','rso-rpt/view','sticker/add','sticker/move','rso-rpt/sticker-update'],
		'Rules'=> ['rules/index','rules/create','rules/update','rules/view'],
