...
class AdminController extends \yii\web\Controller {
	...
	public $rootAdminPermission = [
		...
		'Admin' => ['site/admin-menu','params/discount','params/discountupdate','params/discountview','privileges/create','privileges/delete','privileges/index','privileges/update'],
