...
class AdminController extends \yii\web\Controller {
	...
	public $rootAdminPermission = [
		...
		'Rso Report'=>['rso-rpt/current','rso-rpt/close_mod','rso-rpt/delete','rso-rpt/help','rso-rpt/index','rso-rpt/remarks','rso-rpt/settings','rso-rpt/sticker','rso-rpt/update','rso-rpt/view','sticker/add','sticker/move','rso-rpt/sticker-update','rso-rpt/sticker-delete'],
	...
	public $adminPermission = [
		...
		'Rso Report'=>['rso-rpt/close_mod','rso-rpt/help','rso-rpt/index','rso-rpt/remarks','rso-rpt/settings','rso-rpt/sticker','rso-rpt/view','sticker/add','sticker/move','rso-rpt/sticker-update'],
		'Rules'=> ['rules/index','rules/create','rules/update','rules/view'],
	...
	public $adminViewPermission = [
		...
		'Guest' => ['guest/all'],
		'Rso Report'=>['rso-rpt/help','rso-rpt/index','rso-rpt/view'],
	...
	public $rsoLeadPermission = [
		...
		'Guest' => ['guest/all','guest/modify','guest/update'],
		'Rso Report'=>['rso-rpt/current','rso-rpt/close_mod','rso-rpt/help','rso-rpt/index','rso-rpt/sticker','rso-rpt/update','rso-rpt/view'],
		'sales' => ['sales/all','sales/stock'],
	...
	public $rsoPermission = [
		...
		'Membership Type'=>['membership-type/ajaxmoney-convert'],
		'Guest' => ['guest/all','guest/modify','guest/update'],
		'Rso Report'=>['rso-rpt/current','rso-rpt/help','rso-rpt/index','rso-rpt/sticker','rso-rpt/view'],
		'sales' => ['sales/all','sales/stock'],
	...
	public $viewPermission = [
		...
		'Rso Report'=>['rso-rpt/help','rso-rpt/index'],
		'violations' => ['violations/all'],
		'Work Credits'=>['work-credits/all'],
	];
