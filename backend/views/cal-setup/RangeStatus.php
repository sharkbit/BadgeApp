			...
			[
				...
				'buttons'=>[
					'view' => function($url,$model) {
						...
						return  Html::a(' <span class="glyphicon glyphicon-eye-open"></span> ', ['/cal-setup/view','id'=>$model->range_status_id], [
							'data-toggle'=>'tooltip',
							'data-placement'=>'top',
							'title'=>'View',
						]);}
					...
					'update' => function($url,$model) {
						if (yii::$app->controller->hasPermission('cal-setup/updateran')) {
						return  Html::a(' <span class="glyphicon glyphicon-pencil"></span> ', ['/cal-setup/updateran','id'=>$model->range_status_id], [
							'data-toggle'=>'tooltip',
							'data-placement'=>'top',
							'title'=>'Update',
						]);}
