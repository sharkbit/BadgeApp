						...
						<ul>
							...
							foreach ($agc_event as $an_event) {
								switch ($an_event->e_type) {
									case 'cio':
										$e_type = "CIO Sponsored";
										break;
									case 'club':
										$e_type = "Club Sponsored";
										break;
									case 'vol':
										$e_type = "Volunteer";
										break;
				...
				<?php if ((strpos(strtolower(" " . $_SERVER['SERVER_NAME']), "badge")) || (Yii::$app->params['env'] == 'dev')) { ?>
					<div style=" padding: 20px;">
						...
						<div class="events-box box" style="box-shadow: 3px 20px 79px #a2a2a2; padding: 15px 15px;">
							<p> </p>
							<center>
								<h3><a href="/site/new-member">New Member Signup</a></h3>
							</center>
						</div>
					</div>
				<?php } ?>
	...
	<script>
		...
		<?php if ($agc_event) { ?>
			...
			function jsReg() {
				...
				if (document.getElementById("event_att-ea_badge")) {
					var reg_badge = document.getElementById("event_att-ea_badge").value;
				}
				...
				if (reg_badge > 1) {
					...
					if ((f_name) && (l_name)) {
						...
						alert("Please check that first and last name is specified");
					}
