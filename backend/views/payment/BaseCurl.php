...
class BaseCurl{
  ...
  public function setupOption($k, $v){
      if($this->isCurlSet()){
        ...
        throw new \Exception("cURL instance is not set when calling setup Option.");
      }
  }
  /**
  ...
  public function setupCurlOptArray(array $ary){
    if($this->isCurlSet()){
      ...
      throw new \Exception("cURL instance is not set when calling setup curl Option from array.");
    }
  }
  /**
   * Send the request
  ...
  public function execute(){
    if($this->isCurlSet()){
      ...
      throw new \Exception("cURL instance is not set when trying to execute it.");
    }
  }
  /**
  ...
  public function errno(){
    if($this->isCurlSet()){
      ...
      throw new \Exception("cURL instance is not set when trying to get errno code from the execution.");
    }
  }
  /**
  ...
  public function error(){
    if($this->isCurlSet()){
      ...
      throw new \Exception("cURL instance is not set when trying to get error from the execution.");
    }
  }
  /**
  ...
  public function getInfo($type)
  {
    if($this->isCurlSet()){
      ...
      throw new \Exception("cURL instance is not set when trying to get info from the type:" . $type);
    }
  }
  /**
