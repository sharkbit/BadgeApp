...
<?php if(yii::$app->controller->hasPermission('calendar/conflict')) { ?>
	<li class="<?php if($urlStatus['actionId']=='conflict')echo'active';?>"><a href="<?=Url::to(['/calendar/conflict'])?>"> <span class="glyphicon glyphicon-cloud"></span> Conflicted Events</a></li> <?php } ?>
