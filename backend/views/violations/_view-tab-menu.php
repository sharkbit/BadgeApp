...
<ul class="nav nav-tabs">
    <li class="<?php if(strpos(" ".$urlStatus['requestUrl'],'/violations/index')>0)echo'active';?>"> <a href="<?=Url::to(['/violations/index'])?>"><span class="glyphicon glyphicon-eye-open"></span> Violations</a></li>
...
<?php } if(yii::$app->controller->hasPermission('rules/index')) { ?>
    <li class="<?php if(strpos(" ".$urlStatus['requestUrl'],'/rules/index')>0)echo'active';?>"><a href="<?=Url::to(['/rules/index'])?>"> <span class="glyphicon glyphicon-wrench"></span> Rules</a></li>
<?php } ?>
</ul>
