            ...
            <?= GridView::widget([
                    ...
                    'columns' => [
						...
						[	'attribute'=>'self_service',
							...
							'filter' => \yii\helpers\Html::activeDropDownList($searchModel, 'self_service', ['1' => 'Visible', '0' => 'Not Visible'],['class'=>'form-control','prompt' => 'All']),
                        ],
                        'sku_full',
						...
						[	'attribute'=>'renew_yearly',
							...
							'filter' => \yii\helpers\Html::activeDropDownList($searchModel, 'renew_yearly', ['1' => 'Yes', '0' => 'No'],['class'=>'form-control','prompt' => 'All']),
                        ],
						[	'attribute'=>'stauts',
